...
#define lcd_cs_clr() {GPIO_ResetBits(GPIOC,GPIO_Pin_10);}
#define lcd_cs_set() {GPIO_SetBits(GPIOC,GPIO_Pin_10);}
#define lcd_reset_clr() {GPIO_ResetBits(GPIOC,GPIO_Pin_11);}
#define lcd_reset_set() {GPIO_SetBits(GPIOC,GPIO_Pin_11);}
#define lcd_rs_clr() {GPIO_ResetBits(GPIOC,GPIO_Pin_12);}
#define lcd_rs_set() {GPIO_SetBits(GPIOC,GPIO_Pin_12);}

#define lcd_sclk_clr() {GPIO_ResetBits(GPIOB,GPIO_Pin_13);}
#define lcd_sclk_set() {GPIO_SetBits(GPIOB,GPIO_Pin_13);}
#define lcd_data_clr() {GPIO_ResetBits(GPIOB,GPIO_Pin_15);}
#define lcd_data_set() {GPIO_SetBits(GPIOB,GPIO_Pin_15);}
	
#define lcd_bg_clr() {GPIO_ResetBits(GPIOC,GPIO_Pin_9);}
#define lcd_bg_set() {GPIO_SetBits(GPIOC,GPIO_Pin_9);}
