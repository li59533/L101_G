...
// 	sbuf[0]=(fp->fptr%10000)/1000+'0';
// 	sbuf[1]=(fp->fptr%1000)/100+'0';
// 	sbuf[2]=(fp->fptr%100)/10+'0';
// 	sbuf[3]=(fp->fptr%10)/1+'0';
// 	sbuf[4]=0;
// 		HZ_PutString(300, 20 , "fp->fptr",0xfa00,0);
// 	  HZ_PutString(380, 20 , sbuf,0xfa00,0);

// 	sbuf[0]=(btr%10000)/1000+'0';
// 	sbuf[1]=(btr%1000)/100+'0';
// 	sbuf[2]=(btr%100)/10+'0';
// 	sbuf[3]=(btr%10)/1+'0';
// 	sbuf[4]=0;
// 	HZ_PutString(500, 20 , "btr=",0xfa00,0);
// 	HZ_PutString(580, 20 , sbuf,0xfa00,0);
