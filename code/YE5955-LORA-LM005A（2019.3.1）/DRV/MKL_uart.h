...
#define UART1_IRQ_ENABLE        0                                               /* 串口中断允许          */

#define UART2_DEFAULT_OPEN      1                                               /* 是否允许传输          */                              
#define UART2_IRQ_ENABLE        1                                               /* 串口中断允许          */

#define UART0_SEND_IRQ          1                                               
#define UART0_RECEIVE_IRQ       1
#define UART1_SEND_IRQ          1
#define UART1_RECEIVE_IRQ       1
#define UART2_SEND_IRQ          1
#define UART2_RECEIVE_IRQ       1    
