 ...
 *----------------------------------------------------------------------------*/
    ...
    #define DEFAULT_BUS_CLOCK               13980000u /* Default bus clock value */
#elif (CLOCK_SETUP == 1)
    #define CPU_XTAL_CLK_HZ                 16000000u /*初始的是8M Value of the external crystal or oscillator clock frequency in Hz */
    #define CPU_INT_SLOW_CLK_HZ             32768u   /* Value of the slow internal oscillator clock frequency in Hz  */
    #define CPU_INT_FAST_CLK_HZ             4000000u /* Value of the fast internal oscillator clock frequency in Hz  */
    ...
    #define DEFAULT_BUS_CLOCK               8000000u /* Default bus clock value */    
#endif /* (CLOCK_SETUP == 2) */
...
void SystemInit (void) {
  ...
  /* MCG->C1: CLKS=2, FRDIV=4 IREFS=0,IRCLKEN=1,IREFSTEN=0 *///外部晶振改到16M了，所有分频加一倍，FRDIV=4，原来是3
  MCG->C1 = (uint8_t)0xA2U;//0x9AU
  /* MCG->C4: DMX32=0,DRST_DRS=0 */
  MCG->C4 &= (uint8_t)~(uint8_t)0xE0U;
  /* MCG->C5: ??=0,PLLCLKEN0=0,PLLSTEN0=0,PRDIV0=1 */
  MCG->C5 = (uint8_t)0x07U;//原来的8M，03，现在16M
  /* MCG->C6: LOLIE0=0,PLLS=0,CME0=0,VDIV0=0 */
  MCG->C6 = (uint8_t)0x00U;
